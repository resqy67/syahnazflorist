<div class="relative flex items-center justify-center h-screen">
    ...
    <div class="absolute inset-0">
        <img src="{{ asset('background.jpg') }}" alt="Background"
    ...
    <!-- Content -->
    <div class="relative text-center text-white space-y-4 px-4">
        <h2 class="text-lg font-semibold">Syanaz Florist</h2>
        <h1 class="text-5xl font-bold">Karangan Bunga Balikpapan</h1>
