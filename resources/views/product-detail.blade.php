    ...
    <div class="container mx-auto px-4 py-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-600 text-sm mb-2 mt-2">{{ $product->category->name }}</p>
                <p class="text-2xl font-bold text-green-600 mb-4">Rp{{ number_format($product->price, 0, ',', '.') }}</p>
                ...
                <a href="https://wa.me/6289513688170?text={{ urlencode('Halo, saya ingin memesan karangan bunga berikut:') }}%0A{{ urlencode($product->name) }}%0A%0AMohon informasi lebih lanjut.%0A{{ urlencode(url('product/' . $product->slug)) }}"
                    target="_blank"
                ...
                <div class="mt-6 flex items-center gap-4">
                    <span class="text-gray-500">Ikuti Kami :</span>
